...
class FaultrecordsUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return[
            ...
            'fileNew1'  => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'fileNew2'  => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'fileNew3'  => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'fileNew4'  => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
        ];
    }
}

				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table class="table table-bordered" class="col-xs-6 col-sm-3" id="MyTable">
							<tr>
								@role('root')
									<div style="text-align: left;"><b>Salmones Austral</b> es una empresa de capitales chilenos resultado de la fusión de las compañías Trusal S.A., Salmones Pacific Star S.A. y Comsur Ltda., consolidando más de 25 años de experiencia en crianza y proceso de salmones. Del mismo modo, cuenta con cerca de treinta centros divididos en cultivos en agua dulce y agua mar. A su vez, posee dos plantas de procesos ubicadas en la región de Los Lagos, específicamente en las cercanías de la ciudad de Puerto Montt y en la Isla grande de Chiloé, lo que brinda mayor versatilidad en los procesos y en las entregas, agilizando de esta manera la distribución de forma oportuna y eficiente. Por ello, a través de esta plataforma web se puede consultar, registrar y <b>gestionar todas las eventualidades y fallas operacionales</b> encontradas a lo largo de todas nuestras instalaciones a nivel nacional.</div>
								@else
									<div style="text-align: left;"><b>Salmones Austral</b> es una empresa de capitales chilenos resultado de la fusión de las compañías Trusal S.A., Salmones Pacific Star S.A. y Comsur Ltda., consolidando más de 25 años de experiencia en crianza y proceso de salmones. Del mismo modo, cuenta con cerca de treinta centros divididos en cultivos en agua dulce y agua mar. A su vez, posee dos plantas de procesos ubicadas en la región de Los Lagos, específicamente en las cercanías de la ciudad de Puerto Montt y en la Isla grande de Chiloé, lo que brinda mayor versatilidad en los procesos y en las entregas, agilizando de esta manera la distribución de forma oportuna y eficiente. Por ello, a través de esta plataforma web se puede consultar, registrar y <b>gestionar todas las eventualidades y fallas operacionales</b> encontradas a lo largo de todas nuestras instalaciones a nivel nacional.</div>
								@endrole
							</tr>
